...
static int voice_config_cvs_vocoder(struct voice_data *v)
{
	...
	case VSS_MEDIA_ID_EVRC_MODEM: {
		...
		cvs_set_cdma_rate.cdma_rate.min_rate =
				v->mvs_info.q_min_max_rate.min_rate;
		cvs_set_cdma_rate.cdma_rate.max_rate =
				v->mvs_info.q_min_max_rate.max_rate;
...
#if defined(CONFIG_KOR_MODEL_SHV_E110S) || defined(CONFIG_KOR_MODEL_SHV_E120S) || defined(CONFIG_KOR_MODEL_SHV_E120K) ||defined (CONFIG_KOR_MODEL_SHV_E120L)||defined (CONFIG_USA_MODEL_SGH_T989) || defined(CONFIG_USA_MODEL_SGH_I727) || defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L) || defined(CONFIG_JPN_MODEL_SC_03D)
/* BEGIN: VPCM */
