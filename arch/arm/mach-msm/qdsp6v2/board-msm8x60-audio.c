...
#if defined (CONFIG_TARGET_LOCALE_KOR) || defined(CONFIG_JPN_MODEL_SC_03D) || defined (CONFIG_USA_MODEL_SGH_T989)  || defined (CONFIG_USA_MODEL_SGH_I727) || defined (CONFIG_USA_MODEL_SGH_I717) || defined (CONFIG_USA_MODEL_SGH_I757)
...
{
#ifdef CONFIG_SENSORS_YDA165
	yda165_headset_call_E120L_onoff(1);
#endif
	return 0;
}
...
{
#ifdef CONFIG_SENSORS_YDA165
	yda165_headset_call_E120L_onoff(0);
#endif
	pr_info("%s: power on headset\n", __func__);
}
#endif
...
static void msm_snddev_disable_amic_power(void)
{
...
#if defined(CONFIG_USA_MODEL_SGH_I717)
		if( get_hw_rev() >= 0x3 ){
			gpio_free(PM8058_GPIO_PM_TO_SYS(PMIC_GPIO_MAIN_MICBIAS_EN));
		}
		else{
			ret = pm8058_micbias_enable(OTHC_MICBIAS_0, OTHC_SIGNAL_OFF);
			if (ret)
	...
	if (machine_is_msm8x60_fluid()) {
		...
		if( get_hw_rev() >= 0x03 ){
			...
			gpio_free(PM8058_GPIO_PM_TO_SYS(PMIC_GPIO_SUB_MICBIAS_EN));
		}
		else{
			pr_debug("2.A2220::disable sub_mic off\n");		
			ret = pm8058_micbias_enable(OTHC_MICBIAS_2, OTHC_SIGNAL_OFF);
...
#if 1//defined(CONFIG_USA_MODEL_SGH_I727) || defined(CONFIG_TARGET_LOCALE_KOR) || defined(CONFIG_USA_MODEL_SGH_T989) || defined(CONFIG_JPN_MODEL_SC_03D) || defined (CONFIG_USA_MODEL_SGH_I717)
...
#if defined (CONFIG_KOR_MODEL_SHV_E110S)|| defined (CONFIG_KOR_MODEL_SHV_E120S) || defined (CONFIG_KOR_MODEL_SHV_E120K) || defined (CONFIG_KOR_MODEL_SHV_E160S) || defined (CONFIG_KOR_MODEL_SHV_E160L) || defined (CONFIG_USA_MODEL_SGH_I717)
...
#if defined (CONFIG_KOR_MODEL_SHV_E110S) || defined (CONFIG_KOR_MODEL_SHV_E120S) || defined (CONFIG_KOR_MODEL_SHV_E120K) || defined (CONFIG_KOR_MODEL_SHV_E160S) || defined (CONFIG_KOR_MODEL_SHV_E160L) || defined(CONFIG_USA_MODEL_SGH_I727) || defined (CONFIG_USA_MODEL_SGH_I757)
...
#else
#if defined (CONFIG_USA_MODEL_SGH_I727) || defined(CONFIG_USA_MODEL_SGH_T989) || defined (CONFIG_USA_MODEL_SGH_I717) || defined (CONFIG_USA_MODEL_SGH_I757)
static struct adie_codec_action_unit lineout_rx_48KHz_osr256_actions[] =
...
static struct snddev_icodec_data speaker_vt_rx_data = {
    ...
    || defined (CONFIG_KOR_MODEL_SHV_E120S) || defined (CONFIG_KOR_MODEL_SHV_E120K) || defined (CONFIG_KOR_MODEL_SHV_E120L) || defined (CONFIG_USA_MODEL_SGH_I757)
...
static struct snddev_icodec_data deskdock_vt_rx_data = {
	...
	.channel_mode = 2,
	.default_sample_rate = 48000,
#if defined (CONFIG_USA_MODEL_SGH_T989)  || defined (CONFIG_USA_MODEL_SGH_I727) || defined (CONFIG_USA_MODEL_SGH_I757)
	.pamp_on = msm_snddev_poweramp_on_call,
	.pamp_off = msm_snddev_poweramp_off_call,
#else	
	.pamp_on = msm_snddev_poweramp_on,
