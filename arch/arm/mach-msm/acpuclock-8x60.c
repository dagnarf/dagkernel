...
static struct clkctl_acpu_speed acpu_freq_tbl_fast[] = {
  ...
  { {1, 1}, 1350000,  ACPU_SCPLL, 0, 0, 1, 0x19, L2(16), 1100000, 0x03006000},
  { {1, 1}, 1566000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(17), 1125000, 0x03006000},
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(20), 1175000, 0x03006000},
  { {1, 1}, 1755000,  ACPU_SCPLL, 0, 1, 1, 0x21, L2(21), 1225000, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(21), 1250000, 0x03006000},
  { {1, 1}, 1809000,  ACPU_SCPLL, 0, 1, 1, 0x22, L2(21), 1250000, 0x03006000},
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(21), 1250000, 0x03006000},
  { {1, 1}, 1863000,  ACPU_SCPLL, 0, 1, 1, 0x23, L2(21), 1250000, 0x03006000},
