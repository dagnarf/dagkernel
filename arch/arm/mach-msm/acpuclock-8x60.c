...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[17] = {1404000,  1, 0x1A, 1200000, 1212500, 3},
	[18] = {1620000,  1, 0x1E, 1200000, 1212500, 4},
	[19] = {1674000,  1, 0x1F, 1200000, 1212500, 4},
#ifndef CONFIG_DAG
	[20] = {1728000,  1, 0x20, 1350000, 1450000, 4},
	[21] = {1782000,  1, 0x21, 1425000, 1525000, 4},
	[22] = {1836000,  1, 0x22, 1450000, 1550000, 4},
#else
	[20] = {1728000,  1, 0x20, 1200000, 1212500, 5},
	[21] = {1782000,  1, 0x21, 1200000, 1212500, 5},
	[22] = {1836000,  1, 0x22, 1200000, 1212500, 5},
#endif
};
...
//  { {1, 1},  192000,  ACPU_PLL_8, 3, 1, 0, 0,    L2(1),   812500, 0x03006000},
  { {1, 1},  27000,   ACPU_PLL_8, 3, 1, 0, 0,    L2(1),   775000, 0x03006000},
  /* MAX_AXI row is used to source CPU cores and L2 from the AFAB clock. */
  { {0, 0},  MAX_AXI, ACPU_AFAB,  1, 0, 0, 0,    L2(0),   875000, 0x03006000},
  { {1, 1},  270000,  ACPU_PLL_8, 3, 0, 0, 0,    L2(1),   850000, 0x03006000},
  { {1, 1},  486000,  ACPU_SCPLL, 0, 0, 1, 0x09, L2(2),   912500, 0x03006000},
  { {1, 1},  702000,  ACPU_SCPLL, 0, 0, 1, 0x0D, L2(6),   975000, 0x03006000},
  { {1, 1},  918000,  ACPU_SCPLL, 0, 0, 1, 0x11, L2(10), 1037500, 0x03006000},
  { {1, 1}, 1134000,  ACPU_SCPLL, 0, 0, 1, 0x15, L2(14), 1075000, 0x03006000},
...
#ifndef CONFIG_DAG
  { {1, 1}, 1755000,  ACPU_SCPLL, 0, 1, 1, 0x20, L2(20), 1262500, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(20), 1275000, 0x03006000},
  { {1, 1}, 1809000,  ACPU_SCPLL, 0, 1, 1, 0x21, L2(20), 1275000, 0x03006000},
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(20), 1300000, 0x03006000},
  { {1, 1}, 1890000,  ACPU_SCPLL, 0, 0, 1, 0x23, L2(20), 1325000, 0x03006000},
#else
  { {1, 1}, 1755000,  ACPU_SCPLL, 0, 1, 1, 0x20, L2(20), 1262500, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(20), 1275000, 0x03006000},
  { {1, 1}, 1809000,  ACPU_SCPLL, 0, 1, 1, 0x21, L2(20), 1275000, 0x03006000},
