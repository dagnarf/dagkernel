...
#define L_VAL_SCPLL_CAL_MAX	0x23 /* = 1998 MHz with 27MHz source */
...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[17] = {1404000,  1, 0x1A, 1200000, 1250000, 3},
	[18] = {1620000,  1, 0x1E, 1200000, 1225000, 4},
    [19] = {1728000,  1, 0x20, 1200000, 1225000, 4},
	[20] = {1782000,  1, 0x21, 1200000, 1225000, 4},
	[21] = {1836000,  1, 0x22, 1200000, 1225000, 4},
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_fast[] = {
  { {1, 1},  54000,   ACPU_PLL_8, 3, 1, 0, 0,    L2(1),   775000, 0x03006000},
  /* MAX_AXI row is used to source CPU cores and L2 from the AFAB clock. */
  { {0, 0},  MAX_AXI, ACPU_AFAB,  1, 0, 0, 0,    L2(0),   875000, 0x03006000},
  { {1, 1},  108000,  ACPU_PLL_8, 3, 1, 0, 0,    L2(1),   782500, 0x03006000},
  { {1, 1},  162000,  ACPU_PLL_8, 3, 1, 0, 0,    L2(1),   805000, 0x03006000},
  { {1, 1},  216000,  ACPU_PLL_8, 3, 0, 0, 0,    L2(1),   832500, 0x03006000},
  { {1, 1},  270000,  ACPU_PLL_8, 3, 0, 0, 0,    L2(1),   845000, 0x03006000},
  { {1, 1},  324000,  ACPU_PLL_8, 3, 0, 0, 0,    L2(1),   855500, 0x03006000},
  { {1, 1},  378000,  ACPU_PLL_8, 3, 0, 0, 0,    L2(1),   875000, 0x03006000},
  ...
  { {1, 1}, 1296000,  ACPU_SCPLL, 0, 0, 1, 0x18, L2(16), 1125000, 0x03006000},
  { {1, 1}, 1350000,  ACPU_SCPLL, 0, 0, 1, 0x19, L2(16), 1150000, 0x03006000},
  { {1, 1}, 1404000,  ACPU_SCPLL, 0, 0, 1, 0x1A, L2(17), 1175000, 0x03006000},
  { {1, 1}, 1458000,  ACPU_SCPLL, 0, 0, 1, 0x1B, L2(17), 1187500, 0x03006000},
  { {1, 1}, 1512000,  ACPU_SCPLL, 0, 0, 1, 0x1C, L2(17), 1200000, 0x03006000},
  { {1, 1}, 1566000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(17), 1225000, 0x03006000},
  { {1, 1}, 1620000,  ACPU_SCPLL, 0, 0, 1, 0x1E, L2(18), 1250000, 0x03006000},
  { {1, 1}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(18), 1250000, 0x03006000},
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(18), 1275000, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(19), 1300000, 0x03006000},
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(19), 1325000, 0x03006000},
//  { {0, 0}, 1944000,  ACPU_SCPLL, 0, 0, 1, 0x24, L2(19), 1550000, 0x03006000},
//  { {0, 0}, 2052000,  ACPU_SCPLL, 0, 0, 1, 0x26, L2(20), 1600000, 0x03006000},
  { {0, 0}, 0 },
};
...
//  { {1, 1},  192000,  ACPU_PLL_8, 3, 1, 0, 0,    L2(1),   812500, 0x03006000},
  ...
  { {1, 1},  270000,  ACPU_PLL_8, 3, 0, 0, 0,    L2(1),   825000, 0x03006000},
  { {1, 1},  486000,  ACPU_SCPLL, 0, 0, 1, 0x09, L2(2),   925000, 0x03006000},
  { {1, 1},  702000,  ACPU_SCPLL, 0, 0, 1, 0x0D, L2(6),   975000, 0x03006000},
  { {1, 1},  918000,  ACPU_SCPLL, 0, 0, 1, 0x11, L2(10), 1030000, 0x03006000},
  { {1, 1}, 1134000,  ACPU_SCPLL, 0, 0, 1, 0x15, L2(14), 1057500, 0x03006000},
  { {1, 1}, 1350000,  ACPU_SCPLL, 0, 0, 1, 0x19, L2(16), 1050000, 0x03006000},
  { {1, 1}, 1566000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(17), 1150000, 0x03006000},
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(19), 1200000, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(19), 1250000, 0x03006000},
