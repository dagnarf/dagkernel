...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[18] = {1620000,  1, 0x1E, 1225000, 1250000, 4},
	[19] = {1674000,  1, 0x2F, 1225000, 1250000, 4},
	[20] = {1782000,  1, 0x21, 1250000, 1275000, 4},
...
//  { {1, 1},  192000,  ACPU_PLL_8, 3, 1, 0, 0,    L2(1),   812500, 0x03006000},
  { {1, 1},  54000,   ACPU_PLL_8, 3, 1, 0, 0,    L2(1),   810000, 0x03006000},
  /* MAX_AXI row is used to source CPU cores and L2 from the AFAB clock. */
  { {0, 0},  MAX_AXI, ACPU_AFAB,  1, 0, 0, 0,    L2(0),   875000, 0x03006000},
  ...
  { {1, 1}, 1134000,  ACPU_SCPLL, 0, 0, 1, 0x15, L2(14), 1075000, 0x03006000},
  { {1, 1}, 1350000,  ACPU_SCPLL, 0, 0, 1, 0x19, L2(16), 1150000, 0x03006000},
  { {1, 1}, 1566000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(17), 1200000, 0x03006000},
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(18), 1225000, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(18), 1250000, 0x03006000},
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(18), 1275000, 0x03006000},
  { {0, 0}, 0 },
};
