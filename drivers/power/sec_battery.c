...
#if defined (CONFIG_USA_MODEL_SGH_I727) || defined(CONFIG_USA_MODEL_SGH_I717) || defined(CONFIG_USA_MODEL_SGH_I757) || defined (CONFIG_USA_MODEL_SGH_I577)
#if defined (CONFIG_PMIC8058_XOADC_CAL)
...
#elif defined (CONFIG_USA_MODEL_SGH_T989D)|| defined (CONFIG_USA_MODEL_SGH_T769)
...
#define HIGH_RECOVER_TEMP_ADC_SETTHERM	    374
#define LOW_BLOCK_TEMP_ADC_SETTHERM		    218
#define LOW_RECOVER_TEMP_ADC_SETTHERM	    243
#else
...
#if defined (CONFIG_TARGET_LOCALE_USA)
	if (info->ui_full_charge_status)
		printk("%s: device is in the ui full charge status\n", __func__);
#endif	
