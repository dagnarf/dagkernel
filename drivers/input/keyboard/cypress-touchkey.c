...
static int touchkey_keycode[] = {NULL, KEY_BACK, KEY_ENTER, KEY_MENU, KEY_END}; // BEHOLD3
  ...
  || defined (CONFIG_USA_MODEL_SGH_I717) || defined (CONFIG_KOR_MODEL_SHV_E120K) || defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L) || defined (CONFIG_USA_MODEL_SGH_T769) || defined(CONFIG_USA_MODEL_SGH_I577)
static int touchkey_keycode[5] = {0,KEY_MENU , KEY_HOME, KEY_BACK, KEY_SEARCH};
#elif defined(CONFIG_USA_MODEL_SGH_I757) // key map reverse in I757(CeloxHD)
static int touchkey_keycode[5] = {0,KEY_SEARCH , KEY_BACK, KEY_HOME, KEY_MENU};
#else
...
#if defined (CONFIG_USA_MODEL_SGH_T989)||defined (CONFIG_USA_MODEL_SGH_I727) || defined (CONFIG_USA_MODEL_SGH_I717) || defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L) \
|| defined(CONFIG_USA_MODEL_SGH_I757) || defined (CONFIG_USA_MODEL_SGH_T769) || defined(CONFIG_USA_MODEL_SGH_I577)
...
static int i2c_touchkey_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
 ...
 || defined (CONFIG_USA_MODEL_SGH_I717) || defined (CONFIG_KOR_MODEL_SHV_E120K) || defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L) || defined(CONFIG_USA_MODEL_SGH_I757) || defined (CONFIG_USA_MODEL_SGH_T769) || defined(CONFIG_USA_MODEL_SGH_I577)
...
|| defined (CONFIG_USA_MODEL_SGH_I717) || defined (CONFIG_USA_MODEL_SGH_T769)
 ...
 || defined (CONFIG_USA_MODEL_SGH_I717) || defined(CONFIG_USA_MODEL_SGH_I757) || defined(CONFIG_USA_MODEL_SGH_I577)
		int_data = int_data *0x10;
#else
...
#elif defined (CONFIG_USA_MODEL_SGH_I717) || defined(CONFIG_KOR_MODEL_SHV_E160S) || defined(CONFIG_KOR_MODEL_SHV_E160K) || defined (CONFIG_KOR_MODEL_SHV_E160L) || defined(CONFIG_USA_MODEL_SGH_I757) || defined(CONFIG_USA_MODEL_SGH_I577)
		set_irq_type(IRQ_TOUCHKEY_INT, IRQ_TYPE_EDGE_FALLING);
#elif defined (CONFIG_USA_MODEL_SGH_T989) || defined (CONFIG_USA_MODEL_SGH_T769)
	if (get_hw_rev() >= 0x0d){
		set_irq_type(IRQ_TOUCHKEY_INT, IRQ_TYPE_EDGE_RISING);	
...
#if !defined (CONFIG_KOR_SHV_E120L_HD720) && !defined (CONFIG_KOR_MODEL_SHV_E120S) && !defined (CONFIG_KOR_MODEL_SHV_E120K) && !defined (CONFIG_KOR_MODEL_SHV_E110S) && !defined (CONFIG_KOR_MODEL_SHV_E160S) && !defined(CONFIG_KOR_MODEL_SHV_E160K) && !defined(CONFIG_KOR_MODEL_SHV_E160S)
    if(retry < 0)
        return 0;
#endif
...
#elif defined (CONFIG_USA_MODEL_SGH_I717)
if (((data[1] != 0x02) && (data[2] == 0x1))|| ((((data[1] == 0x0) && (data[2] == 0x0) )||((data[1] == 0xff) && (data[2] == 0xff) ))))
{
...
#elif defined(CONFIG_USA_MODEL_SGH_I757)
	if( (data[1] != 0x01) && (data[2] != 0x01) ) // FW : 2011.09.27
	{
...
printk("%s : update SHV_E120L_WXGA tkey...\n",__func__);	
	...
	if (   ((get_hw_rev() >= 0x0a) && (data[1] != 0x11)) 
		|| ((get_hw_rev() == 0x08) && (data[1] != 0x05)) 
		|| ((get_hw_rev() == 0x06) && (data[1] != 0x03))
