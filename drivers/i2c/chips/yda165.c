...
#if defined (CONFIG_TARGET_LOCALE_KOR) || defined(CONFIG_JPN_MODEL_SC_03D) || defined (CONFIG_USA_MODEL_SGH_T989)  || defined (CONFIG_USA_MODEL_SGH_I727) \
...
#if defined (CONFIG_USA_MODEL_SGH_T989)  || defined (CONFIG_USA_MODEL_SGH_I727) || defined (CONFIG_USA_MODEL_SGH_I717) || defined(CONFIG_USA_MODEL_SGH_I757) || defined(CONFIG_USA_MODEL_SGH_I577)
...
void yda165_headset_call_E120L_onoff(int onoff) /* headset path amp onoff */
{
	D4HP3_SETTING_INFO stInfo;
	...
	if (onoff)
	{
		...
		cur_mode = 4;
		//pr_info(MODULE_NAME ":E120L headset on[cur_mode:%d]\n", cur_mode);
		...
		stInfo.bHpAtt = g_ampgain[cur_mode].hp_att; 				/* HP attenuator */ 
		pr_info(MODULE_NAME ":E120L headset on[cur_mode:%d bHpAtt=%d]\n", cur_mode,stInfo.bHpAtt );
